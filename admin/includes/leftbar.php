...
<li class=" nav-item"><a href="#"><i class="la la-file"></i><span class="menu-title" data-i18n="nav.footers.main">Lokasi</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="add-course.php" data-i18n="nav.footers.footer_light">Add Location</a>
            </li>
            <li><a class="menu-item" href="manage-course.php" data-i18n="nav.footers.footer_dark">Manage Location</a>
            </li>
