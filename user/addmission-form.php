...
?>
<p style="font-size:16px; color:red" align="center">DATA TELAH DIKUMPUL.</p>
...
<div class="row" style="margin-top: 2%">
  <div class="col-xl-12 col-lg-12"><h4 class="card-title">PENDIDIKAN</h4>
<hr />
  </div>
</div>
<div class="row">
